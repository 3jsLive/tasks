...
const linterClass = require( `../src/StyleLint` );

const testBasePath = `${__dirname}/data/StyleLint`;
const goldData = JSON.parse( fs.readFileSync( `${__dirname}/data/StyleLint/gold.json`, 'utf8' ) );
