 ...
 */
export class ParameterDeclaration implements TypedDeclaration, OptionalDeclaration {
    constructor(public name: string, public type: any | undefined, public isOptional: boolean, public start?: number, public end?: number) { }
}
